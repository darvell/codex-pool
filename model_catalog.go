...
var poolModels = []poolModel{
	...
	{AccountType: AccountTypeClaude, ID: "claude-sonnet-5", DisplayName: "Claude Sonnet 5", ContextWindow: 1000000, MaxTokens: 64000, Reasoning: true, WebSearch: true, Input: []string{"text", "image"}, Aliases: []string{"sonnet"}, Cost: &piModelCost{Input: 2, Output: 10, CacheRead: 0.2, CacheWrite: 2.5}},
	...
	{AccountType: AccountTypeClaude, ID: "claude-opus-5", DisplayName: "Claude Opus 5", ContextWindow: 1000000, MaxTokens: 128000, Reasoning: true, Input: []string{"text", "image"}, Aliases: []string{"opus"}, Cost: &piModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25}},
	{AccountType: AccountTypeClaude, ID: "claude-opus-4-8", DisplayName: "Claude Opus 4.8", ContextWindow: 1000000, MaxTokens: 128000, Reasoning: true, Input: []string{"text", "image"}, Cost: &piModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25}},
	...
	{AccountType: AccountTypeClaude, ID: "claude-sonnet-4-6", DisplayName: "Claude Sonnet 4.6", ContextWindow: 1000000, MaxTokens: 64000, Reasoning: true, WebSearch: true, Input: []string{"text", "image"}, Cost: &piModelCost{Input: 3, Output: 15, CacheRead: 0.3, CacheWrite: 3.75}},
